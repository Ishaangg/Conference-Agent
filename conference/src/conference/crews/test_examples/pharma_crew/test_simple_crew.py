#!/usr/bin/env python3
"""
Test script for the simplified PharmaCrewSimple.
"""
...
sys.path.insert(0, str(Path(current_dir).parent.parent.parent.parent))

from conference.crews.pharma_crew.simple_pharma_crew import PharmaCrewSimple
...
def main():
    ...
    print(f"Running Pharma Crew Simple on test data...")
    try:
        pharma_crew = PharmaCrewSimple(test_input_path, test_output_path)
        result = pharma_crew.run()
